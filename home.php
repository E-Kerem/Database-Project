...
<table>
    <?php
//    $sql = "CREATE VIEW book_view AS
//SELECT B.book_id, B.title, G.genre_name, B.rating, EB.price
//FROM book B, genre G, belongs BE, ebook EB
//WHERE BE.book_id = B.book_id AND G.genre_id = BE.genre_id AND EB.book_id = B.book_id;";
//
...
while ($row = $result->fetch_assoc()) {
  ...
  echo "<tr><td>Book title: ", $row["title"], "</td>
                    ...
                    <td><a href='reviewbook.php?booktitle=", $booktitle, "&genrename=",$genrename, "&bookrating=", $bookrating, "&bookprice=", $bookprice, "&bookid=", $bookid, "'>   Review</a></td>
                </tr>";
}
echo "</table>";
